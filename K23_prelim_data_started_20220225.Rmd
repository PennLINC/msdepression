...
Results
  Depression group: 232 with depression, 148 healthy. PHQ2
  Looking at each person's first scan:
    ...
    *Sex effects:
      ...
      - Analyses to consider at a later date
        [] looking at overall fascicle prop lost (rather than inidiv region)
        [] dep * sex
    ...
    *Depression over all fascicles:
      ...
      - total proportion lost within depression network - trend (0.059) between depressed (35%) and healthy(30%)
      - total proportion lost within depression 10% network - p =  0.049 (depressed (33%) have more loss than healthy (27%))
      - total proportion lost outside depression network- p = 0.037 (depressed (18%) more than healthy(16%))
