...
20211012
 [] Working on getting a sample MS mimosa output into HCP space
...
export PATH=${ANTSPATH}:$PATH
mimosaa_path=mimosa_binary_mask_0.25.nii.gz #this is from mimosa output
