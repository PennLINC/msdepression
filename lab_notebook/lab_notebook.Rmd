...
[] no cerebellum -> should I find a way to do a flat representation?

Need to install python and pennlinc toolkit

First installed pip (python3 is what i am using)


1. navigate to your git directory of choice (/Users/eballer/BBL/msdepression/erica_local_git/)
2. git clone https://github.com/PennLINC/PennLINC-Kit.git 
3. Activate your python environment of choice [python3]
4. in the cloned directory: pip install -e . (/Users/eballer/BBL/msdepression/erica_local_git/PennLINC-Kit)
5. That should do it.. you can then load up your python interpreter and should be able to import pennlinckit, or from pennlinckit import … where … is whatever function or subpackage you want to import
