...
msdisease_within_versus_outside_depression_network_nondep_group_sums_scaled_by_size_wilcoxon_eff_size <- rstatix::wilcox_effsize(df_empi_dx_network_proportions[(df_empi_dx_network_proportions$Diagnosis == "MS-Depression"),], formula = proportion_affected ~ Network, paired = T, conf.level = 0.95, ci.type = "perc", nboot = 1000)
...
scatter_effsize_val_by_dep_net_overlap_log <- ggplot(data=df_fascicle_dep_mask_volume_overlap_effsize_value, aes(x=volume_in_dep_mask, y=dep_vs_healthy_effsize, color=dep_vs_healthy_effsize)) +
  ...
  theme(plot.title=element_text(hjust=0.5),
        ...
        legend.position = "none",
        aspect.ratio = 4/4) + 
  annotate("text", x=1.5, y=0.14, size = 5, 
           label = paste0("P = ", round(summary(dep_overlap_x_dep_vs_healthy_vol_effsize)$coef[2,4],3))) 
