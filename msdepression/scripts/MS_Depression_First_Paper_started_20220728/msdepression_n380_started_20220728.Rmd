...
Results
  ...
  B) Depressed vs Controls Proportions
    
    - Overall dep vs non-dep, p = 0.050 (NS), Dep = 31%, Non dep = 27%
    - Dep vs non, top 25%, **p = 0.047**, Dep = 32%, non dep = 26% 
    - Dep vs non, bottom 75%, no p = 0.057, dep = 30%, non dep = 27%
    
  C) Depressed vs Controls Volume
    
    - Overall dep vs nondep: **p = 0.045**, Dep = 9382, Non dep = 8260
