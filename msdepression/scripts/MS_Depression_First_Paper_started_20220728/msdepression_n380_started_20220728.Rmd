...
Results
  ...
  A) Lesion volume between depressed and controls
    
    - P=0.067, NS
 
  B) Depressed vs Controls Fascicle Affected - Proportions
    
    - Dep vs non-dep, total fascicle proportion affected p = 0.050 (NS), Dep = 31%, Non dep = 27%
    - Dep vs non, top 25%, **p = 0.047**, Dep = 32%, non dep = 26% 
    - Dep vs non, bottom 75%, no p = 0.057, dep = 30%, non dep = 27%
    
  C) Depressed vs Controls Fascicle Affected - Volume
    
    - Dep vs nondep, total fascicle volume affected: **p = 0.045**, Dep = 9382, Non dep = 8260
    - Dep vs nondep in top 25% yes **p = 0.034**, Dep = 4829, non dep = 3914
    - Dep vs nondep in bottom 75%, no p = 0.054, dep = 8826, non dep = 7886
  
  D) Linear models of values in fascicle associated with Overlap in Depression map
    
    - T values correlated w/proportion of overlap of fascicle in depression map
        - p of lm (0.010),
        - 95%   ( 0.701,  4.553 )
        - boostrap p calc from CI - **0.0087**
        
    - Cohen'd correlated w/proportion of overlap of fascicle w/depression map
        - p of lm (0.001)
        - 
        
    - T values correlated w/volume of overlap with depression network (i.e. # voxels that fascicle shares w/depression map),
        - p = 0.031
        - 95%   ( 1.052,  3.724 )
        - bootstrap p calc from CI- **1*10^-16**
        
    - Cohen'd correlated w/volume of overlap of fascicle w/depression map
        - p of lm (p < 2.2 * 10^-16)
        - Largest effect in corpus callosum
I think it works best when sticking with *volumes* rather than proportions

#### Promis data, late edition

We decided to look at some of the promis data (which measures broad functional categories, though not specifically psychiatric diagnosis) to see if a) measures differed by diagnostic groups and b) whether there were dimensional effects. Unfortunately, the PROMIS picked up in 2018, which was also the same year that Melissa ended her pull, so our n's are small. 

Current ns for people with at least 1 promis score= 
Total n promis scores: 1694-> 1813 
Total n unique individuals w/promis scores: 501->532

Different scores have different # of overall scans
(x<-promis_data[6:15] ; x[!is.na(x)] = 1; x[is.na(x)] = 0, colSums(x))

                  General_Health                  Quality_of_Life                  Physical_Health           Mental_Health_and_Mood 
                            1812                             1567                             1567                             1567 
  Social_Activities_Satisfaction   Carrying_Out_Social_Activities Carrying_Out_Physical_Activities               Emotional_Problems 
                            1567                             1565                             1563                             1563 
                 Fatique_Average     PostOp.PROMIS.Physical.Score 
                            1563                             1504 


W/good mimosa:
Total n promis scores : 398 -> 412
Total n unique individuals w/promis scores: 116 -> 121
Total n unique indivs in nondepressed group = 36
Total n unique individuals in depressed group = 46->49

Method:
To use the promis scores, I cleaned them in a separate script (promis_score_cleaning_2010-2022.Rmd)
In this script, I link each scan with its most proximal promis score. The challenge here is that there is no time linking. Summary of the time (in days and years) between scanning and a promis (these are absolute values, do not indicate before or after).

Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
  1.0   396.0   800.5   933.8  1325.5  2606.0 
    Min.  1st Qu.   Median     Mean  3rd Qu.     Max. 
0.002747 1.087912 2.199176 2.565346 3.641484 7.159341 

Next, I looked at overall differences between diagnostic groups on each of the PROMIS measures, correcting for multiple comparisons w/FDR (Q<0.05).

Then, I looked at the relationship between promis scores and fascicle measures (overall, 1620 analyses done):


Proportion:
Proportion within versus outside depression map correlated w/promis scores (33 analyses per group (11 promis domains x 3 networks [total, depression 25%, nondep 75%]))
    - all participants (121)
    - Depressed + nondepressed (85)
    - Non-depressed alone (36)
    - Depressed alone (49)

Proportion of individual fascicle affected related to promis scores (777 analyses per group (11 promis domains x 77 individual fascicles))
...
Volume within versus outside depression map correlated w/promis scores (33 analyses per group (11 promis domains x 3 networks [total, depression 25%, nondep 75%]))
   - all participants (121)
    - Depressed + nondepressed (85)
    - Non-depressed alone (36)
    - Depressed alone (49)
  
Volume of individual fascicle affected related to promis scores  (777 analyses per group (11 promis domains x 77 individual fascicles))
  - all participants (121)
  - Depressed + nondepressed (85)
  - Non-depressed alone (36)
  - Depressed alone (49)
...
Promis results:
Interestingly, across all 10 scores, with the exception of fatigue, Depressed patients have lower scores (lower = worse functioning), than non-depressed patients. controls. They all fdr correct. What I love about this is fatigue not being different. If fatigue was worse in depressed patients, one could argue that quality of life, health, emotional problems, social activities, etc are all worse because of underlying fatigue. Similarly, as fatigue is a component of the PHQ9 and depression screening, this could be confounding. That they were different in a lot of measures but not fatigue is informative.

Quality_of_Life	0.010			
Physical_Health	0.019			
Mental_Health_and_Mood	0.011		
Social_Activities_Satisfaction	0.001		
Carrying_Out_Social_Activities	0.007			
Carrying_Out_Physical_Activities	0.032			
Emotional_Problems	0.011			
Fatique_Average	0.181			
PostOp.PROMIS.Physical.Score	0.032			
PostOp.PROMIS.Mental.Score	0.001	

Proportion
Proportion within versus outside depression map correlated w/promis scores - NO SIGNIFICANT FINDINGS
  - all participants (121)
  - Depressed + nondepressed (85)
  - Non-depressed alone (36)
  - Depressed alone (49)

Proportion of individual fascicle affected related to promis scores-  NO SIGNIFICANT FINDINGS
  - all participants (121)
  - Depressed + nondepressed (85)
  - Non-depressed alone (36)
  - Depressed alone (49)
...
Volume     
Volume within versus outside depression map correlated w/promis scores -  NO SIGNIFICANT FINDINGS
  - all participants (121)
  - Depressed + nondepressed (85)
  - Non-depressed alone (36)
  - Depressed alone (49)
  
Volume of individual fascicle affected related to promis scores-  NO SIGNIFICANT FINDINGS
  - all participants (121)
  - Depressed + nondepressed (85)
  - Non-depressed alone (36)
  - Depressed alone (49)
  
#### Using volume rather than proportion to determine inside vs outside depression network
It occurred to me that defining the top 25% depression network has been done by looking at proportion overlap, where everything else seems to work best in volume. It made me wonder what would happen if I defined my top 25% network based on the absolute volume of overlap a fascicle had with the depression network, and ranked based on that (rather than the % of fascicle that overlapped). It tests a slightly different hypothesis, where the depression network is though of as a collection of fascicles that have the most dead ending or overlap, i.e. contribute the most volume to the network. Proportion, on the other hand, thinks more about the specificity of the fascicle - i.e. if the majority of a fascicle dead ends in the network, its activity is probably highly specific to the network. In a volume only, the value of that fascicle's contribution would be neglibile. Using volume = house of representatives. using overlap - senate.

Or put another way, if you do by volume, big fascicles get the most potential votes, by virtue of their bigness. It would be entirely possible for the AF, for example, to have some of the highest overlap with respect to volume, but if that volume is only 10% of the AF fascicle, it means that 90% dead end outside of the depression network. If a tiny fascicle is entirely hit, at least we know there is some specificity to its existence. Conversely, if the AF accounts for 99% of the volume overlap w/the depression network, even if it only 10% of the volume of the AF, it seems like it should be valued highly as part of the depression network. Luckily, results from both work out well.

Results after defining the depresion 25% network based on the volume rather than proportion overlap: i.e. a fascicle is in the "depression network" if the volume that it shares with the depression network is in the top 25%. 
  - Irrespective of network, overall disease by volume: Dep > nondep (p=0.045). 
  - Within dep network: dep disease > nondep disease i, p=0.0.034,
  - Outside dep network (bottom 75%), dep disease ~= nondep disease, p = 0.071 (NS)
...
df_people_with_promis_data <- df_demo_and_fascicles %>%
  filter(EMPI %in% promis_data$EMPI) #n=416
...
```{r make_df_with_volume_instead_of_proportion}
...
summary(df_people_with_promis_data_scores_added$distance_from_scan) #mean 873.3 days, median 763 days, range 1 to 2487 days, convert to years
hist(df_people_with_promis_data_scores_added$distance_from_scan) #convert to years
...
hist(df_people_with_promis_data_scores_added$distance_from_scan/364) #convert to years

#sub volume for proportion
#extract data frame that only includes the fascicle proportion lost
df_fascicles_only <- df_people_with_promis_data_scores_added[ , (names(df_people_with_promis_data_scores_added) %in% fascicle_names)]
df_everything_else <- df_people_with_promis_data_scores_added[ , !(names(df_people_with_promis_data_scores_added) %in% fascicle_names)]
...
#combine back with data_fram
df_demo_and_fascicle_volumes_full_w_promis <- cbind(df_everything_else, df_fascicle_volumes)
...
### with promis data
make_demographics_table_ms_w_promis(data_frame = df_people_with_promis_data_scores_added)

## overall
#just good mimosa w/promis
df_good_mimosa_promis <- df_people_with_promis_data_scores_added %>% filter(depGroupVar != 0)
make_demographics_table_ms_w_promis(df_good_mimosa_promis) #n=287 scans
...
barplot_lesion_volume <- ggplot(data, aes(x=reorder(Diagnosis, -value),fill=Diagnosis, y=value)) + 
  geom_bar(stat="identity", colour="black", width=0.7, size=1.5) + 
...
print(barplot_lesion_volume) #p=0.067


barplot_lesion_volume_range <- ggplot(data, aes(x=reorder(Diagnosis, -value),fill=Diagnosis, y=value)) + 
  geom_bar(stat="identity", colour="black", width=0.7, size=1.5) + 
    geom_errorbar(aes(ymin=value-sem, ymax=value+sem), width=.1, position=position_dodge(0.9), size=1.5) +
  scale_fill_manual(values = c("#cdcdcd", "#FFFFFF")) + #comment out if you want colored graph
  ggtitle(paste0("Volume of Mimosa Lesions by Diagnosis, p=", round(dep_vs_healthy_t_test_lesion_volume$p.value,3))) +
  ylab("Volume of Lesion") +
  ylim(0,20000) +
  theme(title = element_text(size=16, hjust = 0.2),
        axis.text = element_text(size = 14, colour = "black"), axis.title.x = element_blank(), 
        axis.title.y = element_text(size=20),
        aspect.ratio = 5/5,
        axis.line = element_line(size = 1.5, colour = "black", linetype=1),
        panel.background = element_rect(colour = "white", fill = "white"))# + #comment out if you want pretty 
 # scale_y_continuous(expand = c(0, 0), limits = c(0, 20000)) #comment out if you want colored graph
print(barplot_lesion_volume_range) #p=0.067
...
violin_lesion_volume <- ggplot(df_lesion_volume_and_diagnosis, aes(x=depGroupVar, y=volume_of_mimosa_lesions, color=depGroupVar)) +#, fill=depGroupVar)) + 
...
jitter_lesion_volume <- ggplot(df_lesion_volume_and_diagnosis, aes(x=depGroupVar, y=volume_of_mimosa_lesions, color=depGroupVar)) +#, fill=depGroupVar)) + 
  ...
  theme(plot.title = element_text(size=16, hjust = 0.8),
        ...
        aspect.ratio=7/5,
        panel.background = element_rect(colour = "white", fill = "white"))# + #comment out if you want pretty 
print(jitter_lesion_volume) #p=0.067
...
```{r visualize_depression_network_proportion}
##########################################################
#                 Histos                        #
##########################################################
...
#sort based on overlap
fascicle_values_dep_sorted_by_overlap <- fascicle_volumes_dep
fascicle_values_dep_sorted_by_overlap$non_zero_voxels_in_dep_map[is.na(fascicle_values_dep_sorted_by_overlap$non_zero_voxels_in_dep_map)] = 0
fascicle_values_dep_sorted_by_overlap$fascicle <- factor(fascicle_values_dep_sorted_by_overlap$fascicle, levels = fascicle_values_dep_sorted_by_overlap$fascicle[order(fascicle_values_dep_sorted_by_overlap$non_zero_voxels_in_dep_map)])

#remove fascicles with cranial nerves
fascicles_r_and_l_sep_no_cranial_nerves <- fascicle_values_dep_sorted_by_overlap %>% filter(fascicle %in% fascicle_names_no_cranial_nerves)

plot_all_fascicles_r_and_l_sep_no_cranial_nerves <-ggplot(data = fascicles_r_and_l_sep_no_cranial_nerves, aes(x = fascicle, y=non_zero_voxels_in_dep_map))+
...
fascicle_volumes_dep_network_no_cranial_nerves <- fascicle_values_dep_no_cranial_nerves %>%
...
#sort all the fascicles by %overlap, in decreasing order (so highest overlap at the top), and then take the top 1-quartile
dep_network_names_top_quartile_no_cranial_nerves_by_vol<- (fascicle_values_dep_no_cranial_nerves[order(fascicle_values_dep_no_cranial_nerves$non_zero_voxels_in_dep_map, decreasing = TRUE),])$fascicle[1:quartile] #n=19
write.table(dep_network_names_top_quartile_no_cranial_nerves_by_vol, file = paste0(homedir, "/results/dep_network_names_top_quartile_no_cranial_nerves_by_vol.txt"), quote = F, row.names = F, col.names = F)
...
#get a network that includes all of the fascicles NOT in dep 25% network
dep_network_names_bottom_3_quartiles_no_cranial_nerves_by_vol <- fascicle_values_dep_no_cranial_nerves$fascicle[!(fascicle_values_dep_no_cranial_nerves$fascicle %in% dep_network_names_top_quartile_no_cranial_nerves_by_vol)] #n=68
...
fascicles_dep_25_percent_for_plot_no_cranial_nerves <- fascicle_values_dep_sorted_by_overlap[(fascicle_values_dep_sorted_by_overlap$fascicle %in% dep_network_names_top_quartile_no_cranial_nerves_by_vol),]
...
#bottom 3 quartiles
fascicles_dep_bottom_3_quartiles_for_plot_no_cranial_nerves<- fascicle_values_dep_sorted_by_overlap[(fascicle_values_dep_sorted_by_overlap$fascicle %in% dep_network_names_bottom_3_quartiles_no_cranial_nerves_by_vol),]
...
tertile <- round((dim(fascicle_values_dep_no_cranial_nerves)[1] / 3),0)
quintile <- round((dim(fascicle_values_dep_no_cranial_nerves)[1] / 5),0)

dep_network_names_top_tertile_no_cranial_nerves_by_vol<- (fascicle_values_dep_no_cranial_nerves[order(fascicle_values_dep_no_cranial_nerves$non_zero_voxels_in_dep_map, decreasing = TRUE),])$fascicle[1:tertile] #n=26

dep_network_names_top_quintile_no_cranial_nerves_by_vol<- (fascicle_values_dep_no_cranial_nerves[order(fascicle_values_dep_no_cranial_nerves$non_zero_voxels_in_dep_map, decreasing = TRUE),])$fascicle[1:quintile] #n=15

dep_network_names_bottom_tertiles_no_cranial_nerves_by_vol <- fascicle_values_dep_no_cranial_nerves$fascicle[!(fascicle_values_dep_no_cranial_nerves$fascicle %in% dep_network_names_top_tertile_no_cranial_nerves_by_vol)] 

dep_network_names_bottom_quintiles_no_cranial_nerves_by_vol <- fascicle_values_dep_no_cranial_nerves$fascicle[!(fascicle_values_dep_no_cranial_nerves$fascicle %in% dep_network_names_top_quintile_no_cranial_nerves_by_vol)] 

top_tertile_total_volume_no_cranial_nerves <-
sum(fascicle_volumes_dep_network_no_cranial_nerves$num_voxels_total[which(fascicle_volumes_dep_network_no_cranial_nerves$fascicle %in% dep_network_names_top_tertile_no_cranial_nerves_by_vol)])

top_quintile_total_volume_no_cranial_nerves <-
sum(fascicle_volumes_dep_network_no_cranial_nerves$num_voxels_total[which(fascicle_volumes_dep_network_no_cranial_nerves$fascicle %in% dep_network_names_top_quintile_no_cranial_nerves_by_vol)])

bottom_tertiles_total_volume_no_cranial_nerves <-
sum(fascicle_volumes_dep_network_no_cranial_nerves$num_voxels_total[which(fascicle_volumes_dep_network_no_cranial_nerves$fascicle %in% dep_network_names_bottom_tertiles_no_cranial_nerves_by_vol)])

bottom_quintiles_total_volume_no_cranial_nerves<-
sum(fascicle_volumes_dep_network_no_cranial_nerves$num_voxels_total[which(fascicle_volumes_dep_network_no_cranial_nerves$fascicle %in% dep_network_names_bottom_quintiles_no_cranial_nerves_by_vol)])
...
r_color<-ggplot(lesioned_dx, aes(x=value, color=factor(depGroupVar))) + 
...
#### look at mean fascicle volume overlap across participants and transpose
...
write.table(fascicles_alone_rowMeans, file = paste0(homedir, "/results/fascicle_mean_proportion_overlap_nfasc_77.csv"), row.names = FALSE, col.names = FALSE, quote=FALSE, sep = ",")
...
sorted_ggplot<-ggplot(data = fascicle_values_sorted_by_overlap, aes(x = fascicle, y=value, fill=value))+
...
######### 
#############
#### look at mean fascicle overlap across healthy participants and transpose
#############
...
write.table(fascicles_alone_rowMeans, file = paste0(homedir, "/results/fascicle_mean_proportion_overlap_nfasc_77_nondep.csv"), row.names = FALSE, col.names = FALSE, quote=FALSE, sep = ",")
...
sorted_ggplot_healthy_ordered<-ggplot(data = fascicle_values_sorted_by_overlap, aes(x = fascicle, y=value, fill=value))+
...
write.table(fascicles_alone_rowMeans, file = paste0(homedir, "/results/fascicle_mean_proportion_overlap_nfasc_77_dep.csv"), row.names = FALSE, col.names = FALSE, quote=FALSE, sep = ",")
...
# ordered by mean value overall
fascicle_values_sorted_by_overlap$fascicle <- factor(fascicle_values_sorted_by_overlap$fascicle, levels = order_of_mean_values_overall)
sorted_ggplot_depressed_ordered<-ggplot(data = fascicle_values_sorted_by_overlap, aes(x = fascicle, y=value, fill=value))+
  ggtitle("Proportion of Volume per Fascicle Affected Ordered by mean values Depressed") + 
  ylab("Proportion Affected") +
  geom_bar(stat="identity") + 
  #scale_fill_gradient(low = "red", high = "yellow") +
  scale_fill_continuous(type="viridis") + #, color="orange") +
  ylim(0,0.8) +
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1),
        plot.title = element_text(hjust = 0.5, size=14),
        axis.title.x = element_text(size=14),
...
### color by quartile
#num_buckets = round(length(fascicle_values_sorted_by_overlap$fascicle)/4,0) #get the number of quartiles
#color_columns= rep(x = c("#8DD3C7", "#FFFFB3", "#BEBADA", "#FB8072"), times=1, each=num_buckets) #assign each quartile a color
#color_columns= rep(x = c("violet", "blue", "green", "red"), times=1, each=num_buckets) #assign each quartile a color

#if (length(fascicle_values_sorted_by_overlap$fascicle) %% 4 != 0){
 # color_columns=c("#8DD3C7", color_columns) #add one more to the beginning of the vector since the number is odd, so mod is odd number
#}
...
############ Look at mean overall volume across all brain regions
#### look at mean fascicle volume overlap across participants and transpose
# drop exam date and empi, and transpose
fascicles_alone_df_vol <- t(df_demo_and_fascicle_volumes_full[,(colnames(df_demo_and_fascicle_volumes_full) %in% fascicle_names_no_cranial_nerves)])
fascicle_names <- rownames(fascicles_alone_df_vol)

#take row means
fascicles_alone_vol_rowMeans <- data.frame(fascicle_names, rowMeans(fascicles_alone_df_vol))
names(fascicles_alone_vol_rowMeans) <- c("fascicle", "value")

#GET RID OF CRANIAL NERVES
fascicles_alone_vol_rowMeans <- fascicles_alone_vol_rowMeans %>% filter(fascicle %in% fascicle_names_no_cranial_nerves)

write.table(fascicles_alone_vol_rowMeans, file = paste0(homedir, "/results/fascicle_mean_volume_nfasc_77.csv"), row.names = FALSE, col.names = FALSE, quote=FALSE, sep = ",")

#sort based on overlap
fascicle_values_sorted_by_overlap <- fascicles_alone_vol_rowMeans
...
######## Histograms/bargraphs
#this histogram helps contextualize the number of streamlines with varying degrees of proportions affected
hist(x=fascicle_values_dep_sorted_by_overlap$prop_in_mask, main = "Histogram Affected Streamlines", xlab = "Volume per Fascicle Affected", breaks = 20)

sorted_ggplot<-ggplot(data = fascicle_values_sorted_by_overlap, aes(x = fascicle, y=value, fill=value))+
  ggtitle("Volume per Fascicle Affected") + 
  ylab("Volume") + 
  geom_bar(stat="identity") + 
  scale_fill_continuous(type="viridis") + 
  ylim(0,230000) +
...
sorted_ggplot<-ggplot(data = fascicle_values_sorted_by_overlap, aes(x = fascicle, y=value, fill=value))+
  ggtitle("Volume per Fascicle Affected, exclude CC") + 
  ylab("Volume") + 
  geom_bar(stat="identity") + 
  scale_fill_continuous(type="viridis") + 
  ylim(0,30000) +
...
##### healthy volume
df_demo_and_fascicle_volumes_full_nondep <- df_demo_and_fascicle_volumes_full %>% filter(depGroupVar==1)

# drop exam date and empi, and transpose
fascicles_alone_df_vol <- t(df_demo_and_fascicle_volumes_full_nondep[,(colnames(df_demo_and_fascicle_volumes_full_nondep) %in% fascicle_names_no_cranial_nerves)])
fascicle_names <- rownames(fascicles_alone_df_vol)
...
write.table(fascicles_alone_vol_rowMeans, file = paste0(homedir, "/results/fascicle_mean_volume_nfasc_77_nondep.csv"), row.names = FALSE, col.names = FALSE, quote=FALSE, sep = ",")
...
sorted_ggplot<-ggplot(data = fascicle_values_sorted_by_overlap, aes(x = fascicle, y=value, fill=value))+
  ggtitle("Volume per Fascicle Affected Nondepressed") + 
  ylab("Volume") + 
  geom_bar(stat="identity") + 
  scale_fill_continuous(type="viridis") + 
  ylim(0,230000) +
...
sorted_ggplot<-ggplot(data = fascicle_values_sorted_by_overlap, aes(x = fascicle, y=value, fill=value))+
  ggtitle("Volume per Fascicle Affected Nondepressed, exclude CC") + 
  ylab("Volume") + 
  geom_bar(stat="identity") + 
  scale_fill_continuous(type="viridis") + 
  ylim(0,30000) +
...
df_demo_and_fascicle_volumes_full_dep <- df_demo_and_fascicle_volumes_full %>% filter(depGroupVar==2)

fascicles_alone_df_vol <- t(df_demo_and_fascicle_volumes_full_dep[,(colnames(df_demo_and_fascicle_volumes_full_dep) %in% fascicle_names_no_cranial_nerves)])
fascicle_names <- rownames(fascicles_alone_df_vol)
...
write.table(fascicles_alone_vol_rowMeans, file = paste0(homedir, "/results/fascicle_mean_volume_nfasc_77_dep.csv"), row.names = FALSE, col.names = FALSE, quote=FALSE, sep = ",")
...
sorted_ggplot<-ggplot(data = fascicle_values_sorted_by_overlap, aes(x = fascicle, y=value, fill=value))+
  ggtitle("Volume per Fascicle Affected Depressed") + 
  ylab("Volume") + 
  geom_bar(stat="identity") + 
  scale_fill_continuous(type="viridis") + 
  ylim(0,230000) +
...
sorted_ggplot<-ggplot(data = fascicle_values_sorted_by_overlap, aes(x = fascicle, y=value, fill=value))+
  ggtitle("Volume per Fascicle Affected Depressed, exclude CC") + 
  ylab("Volume") + 
  geom_bar(stat="identity") + 
  scale_fill_continuous(type="viridis") + 
  ylim(0,30000) +
...
### of note, order of operations is that you take the mean first, and then you divide by the total volume of the network. One could imagine a situation where you divide by network first, and then take mean, but it seems reasonable to include network measure after calculating the network mean.
...
dep_and_healthy_groups_for_ICD_analysis <- df_demo_and_fascicle_volumes_full %>% 
  ...
  mutate(sum_fascicle_vol_lost = rowSums(across(fascicle_names_no_cranial_nerves))) %>%
  ...
  mutate(total_fascicle_vol_lost_indepnet_top_quartile = 
           rowMeans(across(dep_network_names_top_quartile_no_cranial_nerves_by_vol))) %>%
  mutate(sum_fascicle_vol_lost_indepnet_top_quartile = 
           rowSums(across(dep_network_names_top_quartile_no_cranial_nerves_by_vol))) %>%
  mutate(prop_fascicle_vol_lost_indepnet_top_quartile = (total_fascicle_vol_lost_indepnet_top_quartile / dep_network_total_volume_top_quartile_no_cranial_nerves)) %>%
  ...
  mutate(total_fascicle_vol_lost_nondep_bottom_3_quartiles = 
           rowMeans(across(dep_network_names_bottom_3_quartiles_no_cranial_nerves_by_vol))) %>%
  mutate(sum_fascicle_vol_lost_nondep_bottom_3_quartiles = 
           rowSums(across(dep_network_names_bottom_3_quartiles_no_cranial_nerves_by_vol))) %>%
  mutate(prop_fascicle_vol_lost_bottom_3_quartile = (total_fascicle_vol_lost_nondep_bottom_3_quartiles / bottom_75_total_volume_no_cranial_nerves)) %>% 
  ...
  mutate(total_fascicle_vol_lost_no_cc = rowMeans(across(fascicle_names_no_cranial_nerves[fascicle_names_no_cranial_nerves!="CC"]))) %>%
  mutate(total_fascicle_vol_lost_indepnet_top_quartile_no_cc = 
           rowMeans(across(dep_network_names_top_quartile_no_cranial_nerves_by_vol[dep_network_names_top_quartile_no_cranial_nerves_by_vol != "CC"]))) %>%
  mutate(total_fascicle_vol_lost_nondep_bottom_3_quartiles_no_cc = 
           rowMeans(across(dep_network_names_bottom_3_quartiles_no_cranial_nerves_by_vol[dep_network_names_bottom_3_quartiles_no_cranial_nerves_by_vol != "CC"]))) %>%
  
  # tertile and quintiles
  mutate(sum_fascicle_vol_lost_top_tertile = 
           rowSums(across(dep_network_names_top_tertile_no_cranial_nerves_by_vol))) %>%
  mutate(proportion_volume_lost_top_tertile_by_network_size_sum = sum_fascicle_vol_lost_top_tertile /top_tertile_total_volume_no_cranial_nerves) %>%
    mutate(sum_fascicle_vol_lost_bottom_tertiles = 
           rowSums(across(dep_network_names_bottom_tertiles_no_cranial_nerves_by_vol))) %>%
  mutate(proportion_volume_lost_bottom_tertiles_by_network_size_sum = sum_fascicle_vol_lost_bottom_tertiles /bottom_tertiles_total_volume_no_cranial_nerves) %>%
    mutate(sum_fascicle_vol_lost_top_quintile = 
           rowSums(across(dep_network_names_top_quintile_no_cranial_nerves_by_vol))) %>%
  mutate(proportion_volume_lost_top_quintile_by_network_size_sum = sum_fascicle_vol_lost_top_quintile /top_quintile_total_volume_no_cranial_nerves) %>%
    mutate(sum_fascicle_vol_lost_bottom_quintiles = 
           rowSums(across(dep_network_names_bottom_quintiles_no_cranial_nerves_by_vol))) %>%
  ...
  #remove people who didn't lose anything, i.e. bad data
 # filter(total_fascicle_vol_lost != 0) %>%
  group_by(EMPI) %>% 
  arrange(EXAM_DATE) %>% 
  slice(1) %>% 
  ungroup()
...
#test whether ms preferentially hits within or outside depression network, p = 2.2 * 10^-16, mean lost in dep net = 18027, mean lost outside dep net = 4020. More disease outside versus inside, when you look at means

msdisease_within_versus_outside_depression_network <- t.test(dep_and_healthy_groups_for_ICD_analysis$total_fascicle_vol_lost_indepnet_top_quartile, dep_and_healthy_groups_for_ICD_analysis$total_fascicle_vol_lost_nondep_bottom_3_quartiles, var.equal = F, paired = TRUE) 

#wilcox test because non normally distributed; p < 2.2*10^-16
msdisease_within_versus_outside_depression_network_wilcoxon <- wilcox.test(dep_and_healthy_groups_for_ICD_analysis$total_fascicle_vol_lost_indepnet_top_quartile, dep_and_healthy_groups_for_ICD_analysis$total_fascicle_vol_lost_nondep_bottom_3_quartiles,paired = TRUE) 


#still 2.2*10^-16; mean of dep net: 6856, mean outside dep net = 4020, excluded corpus callosum b/c it is so very big. 
msdisease_within_versus_outside_depression_network_no_cc <- t.test(dep_and_healthy_groups_for_ICD_analysis$total_fascicle_vol_lost_indepnet_top_quartile_no_cc, dep_and_healthy_groups_for_ICD_analysis$total_fascicle_vol_lost_nondep_bottom_3_quartiles_no_cc, var.equal = F, paired = TRUE) 

#2.2*1^-16
msdisease_within_versus_outside_depression_network_no_cc_wilcoxon <- wilcox.test(dep_and_healthy_groups_for_ICD_analysis$total_fascicle_vol_lost_indepnet_top_quartile_no_cc, dep_and_healthy_groups_for_ICD_analysis$total_fascicle_vol_lost_nondep_bottom_3_quartiles_no_cc, paired = TRUE) 





#testing group differences if you scale by the size of the network, still significant, in top quartile, proportion lost = 0.021
#bottom 3, proportion lost = 0.006, p=2.2 * 10^-16

msdisease_within_versus_outside_depression_network_scaled_by_network_size <- t.test(dep_and_healthy_groups_for_ICD_analysis$prop_fascicle_vol_lost_indepnet_top_quartile, dep_and_healthy_groups_for_ICD_analysis$prop_fascicle_vol_lost_bottom_3_quartile, var.equal = F, paired = TRUE) 

#2.2 *10^-16
msdisease_within_versus_outside_depression_network_scaled_by_network_size_wilcoxon <- wilcox.test(dep_and_healthy_groups_for_ICD_analysis$prop_fascicle_vol_lost_indepnet_top_quartile, dep_and_healthy_groups_for_ICD_analysis$prop_fascicle_vol_lost_bottom_3_quartile, paired = TRUE) 

### use sums instead of means
#wilcox test because non normally distributed; sums instead of means, scaled by network size p < 2.2*10^-16, dep net prop = 0.400, non dep = 0.339
...
#wilcox test because non normally distributed; sums instead of means, scaled by network size, only in non_dep people p < 2.2*10^-16
msdisease_within_versus_outside_depression_network_sums_scaled_by_size_wilcoxon_nondep <- wilcox.test(dep_and_healthy_groups_for_ICD_analysis$proportion_volume_lost_dep_net_by_network_size_sum[dep_and_healthy_groups_for_ICD_analysis$depGroupVar == 1], dep_and_healthy_groups_for_ICD_analysis$proportion_volume_lost_nondep_net_by_network_size_sum[dep_and_healthy_groups_for_ICD_analysis$depGroupVar == 1], paired = TRUE) 

#wilcox test because non normally distributed; sums instead of means, scaled by network size, only in dep people p < 2.2*10^-16
msdisease_within_versus_outside_depression_network_sums_scaled_by_size_wilcoxon_dep <- wilcox.test(dep_and_healthy_groups_for_ICD_analysis$proportion_volume_lost_dep_net_by_network_size_sum[dep_and_healthy_groups_for_ICD_analysis$depGroupVar == 2], dep_and_healthy_groups_for_ICD_analysis$proportion_volume_lost_nondep_net_by_network_size_sum[dep_and_healthy_groups_for_ICD_analysis$depGroupVar == 2], paired = TRUE) 
...
#test whether volume lost overall different between depressed and healthy- Yes, p = 0.045, Dep = 9382, Non dep = 8260
total_volume_lost_dep_vs_healthy_unique <- t.test(dep_and_healthy_groups_for_ICD_analysis$total_fascicle_vol_lost[dep_and_healthy_groups_for_ICD_analysis$depGroupVar == 1], dep_and_healthy_groups_for_ICD_analysis$total_fascicle_vol_lost[dep_and_healthy_groups_for_ICD_analysis$depGroupVar == 2], var.equal = F)

#Yes, p=0.046, Dep = 4952, nondep = 4284
total_volume_lost_dep_vs_healthy_unique_no_cc <- t.test(dep_and_healthy_groups_for_ICD_analysis$total_fascicle_vol_lost_no_cc[dep_and_healthy_groups_for_ICD_analysis$depGroupVar == 1], dep_and_healthy_groups_for_ICD_analysis$total_fascicle_vol_lost_no_cc[dep_and_healthy_groups_for_ICD_analysis$depGroupVar == 2], var.equal = F) 


#look at within depression network using top quartiles, yes p = 0.034, Dep = 18957, non dep = 16572
...
#no corpus callosum, p = 0.028, Dep = 7380, nondep = 6036
total_volume_lost_dep_vs_healthy_unique_in_dep_network_top_quartile_no_cc <- t.test(dep_and_healthy_groups_for_ICD_analysis$total_fascicle_vol_lost_indepnet_top_quartile_no_cc[dep_and_healthy_groups_for_ICD_analysis$depGroupVar == 1], dep_and_healthy_groups_for_ICD_analysis$total_fascicle_vol_lost_indepnet_top_quartile_no_cc[dep_and_healthy_groups_for_ICD_analysis$depGroupVar == 2], var.equal = F) 

#look at bottom 75%, p = 0.07, dep = 4198, non dep = 3740
...
#gut check, this should be identical, since CC not in bottom 3 quartiles; p = 0.07, dep = 4198, non dep = 3740
total_volume_lost_dep_vs_healthy_unique_in_bottom_3_quartiles_no_cc <- t.test(dep_and_healthy_groups_for_ICD_analysis$total_fascicle_vol_lost_nondep_bottom_3_quartiles_no_cc[dep_and_healthy_groups_for_ICD_analysis$depGroupVar == 1], dep_and_healthy_groups_for_ICD_analysis$total_fascicle_vol_lost_nondep_bottom_3_quartiles_no_cc[dep_and_healthy_groups_for_ICD_analysis$depGroupVar == 2], var.equal = F) #mean dep = 30%, mean non_dep = 27%, p = 0.057



#### interaction of diagnosis by network
...
df_empi_dx_network_proportions <- dep_and_healthy_groups_for_ICD_analysis %>%
  ...
  #mutate(Dep_network_affected = total_fascicle_vol_lost_indepnet_top_quartile) %>%
  #mutate(Nondep_network_affected = total_fascicle_vol_lost_nondep_bottom_3_quartiles) %>%
 ...
 # mutate(network_size = ifelse(network == "Dep_network", dep_network_total_volume_top_quartile_no_cranial_nerves/scale, bottom_75_total_volume_no_cranial_nerves/scale)) %>%
#  mutate(total_affected_volume_in_net = (proportion_affected * network_size)) %>% 
  mutate(Network = as.factor(Network)) %>%
  ungroup()
  
   
#df_empi_dx_network_proportions <- as.data.frame(df_empi_dx_network_proportions)
...
diagnosis_by_network_interaction_lmer_main_effects <- lmer(proportion_affected ~ Network+Diagnosis + (1|subject), data = df_empi_dx_network_proportions)
summary(diagnosis_by_network_interaction_lmer_main_effects)
...
#diagnosis_by_network_interaction_glmer <- glmer(cbind(total_affected_volume_in_net, network_size-total_affected_volume_in_net) ~ network*diagnosis + (1|subject), data = df_empi_dx_network_proportions, family = binomial(link="logit")) 
#summary(diagnosis_by_network_interaction_glmer )

#diagnosis_by_network_interaction_glmer_plot  <- plot_model(diagnosis_by_network_interaction_glmer , type = "int")
#print(diagnosis_by_network_interaction_glmer_plot)


#pred_df <- df_empi_dx_network_proportions %>% 
 #          dplyr::select(network,diagnosis) %>% 
  #         expand.grid() %>% distinct() %>% mutate(subject = rep(df_empi_dx_network_proportions$subject[1], 4))
 

#predicted_values_means_glmer <- predict(object=diagnosis_by_network_interaction_glmer,newdata=pred_df,se.fit=TRUE, re.form=NA, type = "response")

#predicted_values_means_lmer <- predict(object=diagnosis_by_network_interaction_lmer,newdata=pred_df,se.fit=TRUE, re.form=NA, type = "response")


#pred_lmer <- merTools::predictInterval(diagnosis_by_network_interaction_lmer, newdata =pred_df, n.sims = 999, which = "fixed")

#pred_glmer <- merTools::predictInterval(diagnosis_by_network_interaction_glmer, newdata = pred_df, n.sims = 999, which="fixed")

#pred_df_lmer_w_ci <- cbind(pred_df, pred_lmer)
#pred_df_glmer_w_ci <- cbind(pred_df, pred_glmer)

#plot_pred_df_lmer_plot <- ggplot(pred_df_lmer_w_ci,aes(x=network,y=fit,color=diagnosis, group=diagnosis, ymax=upr,ymin=lwr)) +
 #  geom_point(position = position_dodge(width=0.5),size=1) + geom_errorbar(size=1,position = position_dodge(width=0.5),width=.5)+geom_line(position = position_dodge(width=0.5),size=1) 
#  ylim(0.2,0.5)

#plot_pred_df_glmer_plot <- ggplot(pred_df_glmer_w_ci,aes(x=network,y=fit,color=diagnosis, group=diagnosis, ymax=upr,ymin=lwr)) +
   #geom_point() + geom_errorbar()+geom_line()

#geom_point(aes(color=diagnosis)) + geom_line(aes(color=diagnosis)) + geom_errorbar()


#ggplot(pred_df,aes(x=network,y=mean,color=diagnosis,ymax=upper_ci,ymin=lower_ci)) + geom_point() + geom_errorbar()+geom_line()
#predicted_values_ces <- predict(object=diagnosis_by_network_interaction_glmer,newdata=pred_df,se.fit=TRUE, re.form=NA)

#binomial, model needs to account for the fact that you can't have values outside of the 0-1 range. Change families because outcome variable not from a normal distribution. 
...
df_mean_fascicle_volumes_and_diagnosis <- dep_and_healthy_groups_for_ICD_analysis %>% 
dplyr::select(total_fascicle_vol_lost, total_fascicle_vol_lost_indepnet_top_quartile, total_fascicle_vol_lost_nondep_bottom_3_quartiles, depGroupVar) %>%
  mutate(depGroupVar = ifelse(depGroupVar == 1, "Non-depressed", "Depressed"))

df_mean_fascicle_volumes_and_diagnosis_no_cc <- dep_and_healthy_groups_for_ICD_analysis %>% 
dplyr::select(total_fascicle_vol_lost_no_cc, total_fascicle_vol_lost_indepnet_top_quartile_no_cc, total_fascicle_vol_lost_nondep_bottom_3_quartiles_no_cc, depGroupVar) %>%
  mutate(depGroupVar = ifelse(depGroupVar == 1, "Non-depressed", "Depressed"))


jitter_mean_fascicle_volume <- ggplot(df_mean_fascicle_volumes_and_diagnosis, aes(x=depGroupVar, y=total_fascicle_vol_lost, color=depGroupVar)) +
  geom_jitter(shape=16, position=position_jitter(0.15)) + 
  geom_boxplot(width=0.1, color="black", fill="white", outlier.size = 0.2) + 
  scale_x_discrete(labels=c("1" = "Depressed", "2" = "Non-Depressed")) + 
  ggtitle(paste0("Mean Fascicle Volume Affected by Diagnosis")) +
  ylab("Mean Volume of Fascicles") +
  ylim(0,40000) + 
  theme(plot.title = element_text(size=16, hjust = 0.55),
        ...
        aspect.ratio=7/5,
        panel.background = element_rect(colour = "white", fill = "white"))
print(jitter_mean_fascicle_volume) #p=0.067

jitter_mean_fascicle_volume_dep <- ggplot(df_mean_fascicle_volumes_and_diagnosis, aes(x=depGroupVar, y=total_fascicle_vol_lost_indepnet_top_quartile, color=depGroupVar)) +
  geom_jitter(shape=16, position=position_jitter(0.15)) + 
  geom_boxplot(width=0.1, color="black", fill="white", outlier.size = 0.2) + 
  scale_x_discrete(labels=c("1" = "Depressed", "2" = "Non-Depressed")) + 
  ggtitle(paste0("Mean Fascicle Volume Affected Dep Net by Diagnosis")) +
  ylab("Mean Volume of Fascicles") +
  ylim(0,40000) + 
  theme(plot.title = element_text(size=16, hjust = 0.55),
        axis.text = element_text(size = 14, colour = "black"), axis.title.x = element_blank(), 
        ...
        aspect.ratio=7/5,
        panel.background = element_rect(colour = "white", fill = "white"))
print(jitter_mean_fascicle_volume_dep) #p=0.067

jitter_mean_fascicle_volume_nondep <- ggplot(df_mean_fascicle_volumes_and_diagnosis, aes(x=depGroupVar, y=total_fascicle_vol_lost_nondep_bottom_3_quartiles, color=depGroupVar)) +
  geom_jitter(shape=16, position=position_jitter(0.15)) + 
  geom_boxplot(width=0.1, color="black", fill="white", outlier.size = 0.2) + 
  scale_x_discrete(labels=c("1" = "Depressed", "2" = "Non-Depressed")) + 
  ggtitle(paste0("Mean Fascicle Volume Affected Nondep Net by Diagnosis")) +
  ylab("Mean Volume of Fascicles") +
  ylim(0,40000) + 
  theme(plot.title = element_text(size=16, hjust = 0.55),
        axis.text = element_text(size = 14, colour = "black"), axis.title.x = element_blank(), 
        ...
        aspect.ratio=7/5,
        panel.background = element_rect(colour = "white", fill = "white"))
print(jitter_mean_fascicle_volume_nondep) #p=0.067

##### Geom violin


violin_mean_fascicle_volume <- ggplot(df_mean_fascicle_volumes_and_diagnosis, aes(x=depGroupVar, y=total_fascicle_vol_lost, fill=depGroupVar)) +
  geom_violin() +  
  geom_boxplot(width=0.1, color="black", fill="white", outlier.size = 0.2) + 
  scale_x_discrete(labels=c("1" = "Depressed", "2" = "Non-Depressed")) + 
  ggtitle(paste0("Mean Fascicle Volume Affected by Diagnosis")) +
  ...
  theme(plot.title = element_text(size=16, hjust = 0.55),
        ...
        aspect.ratio=7/5,
        panel.background = element_rect(colour = "white", fill = "white"))
print(violin_mean_fascicle_volume) #p=0.067

violin_mean_fascicle_volume_no_cc <- ggplot(df_mean_fascicle_volumes_and_diagnosis_no_cc, aes(x=depGroupVar, y=total_fascicle_vol_lost_no_cc, fill=depGroupVar)) +
  geom_violin() +  
  geom_boxplot(width=0.1, color="black", fill="white", outlier.size = 0.2) + 
  scale_x_discrete(labels=c("1" = "Depressed", "2" = "Non-Depressed")) + 
  ggtitle(paste0("Mean Fascicle Volume Affected by Diagnosis, No CC")) +
  ylab("Mean Volume of Fascicles") +
  ylim(0,42000) + 
  theme(plot.title = element_text(size=16, hjust = 0.55),
        axis.text = element_text(size = 14, colour = "black"), axis.title.x = element_blank(), 
        ...
        aspect.ratio=7/5,
        panel.background = element_rect(colour = "white", fill = "white"))
print(violin_mean_fascicle_volume_no_cc) #p=0.067



violin_mean_fascicle_volume_dep <- ggplot(df_mean_fascicle_volumes_and_diagnosis, aes(x=depGroupVar, y=total_fascicle_vol_lost_indepnet_top_quartile, fill=depGroupVar)) +
  geom_violin() +  
  geom_boxplot(width=0.1, color="black", fill="white", outlier.size = 0.2) + 
  scale_x_discrete(labels=c("1" = "Depressed", "2" = "Non-Depressed")) + 
  ggtitle(paste0("Mean Fascicle Volume Affected Dep Net by Diagnosis")) +
  ...
  theme(plot.title = element_text(size=16, hjust = 0.55),
        ...
        aspect.ratio=7/5,
        panel.background = element_rect(colour = "white", fill = "white"))
print(violin_mean_fascicle_volume_dep) 

violin_mean_fascicle_volume_dep_no_cc <- ggplot(df_mean_fascicle_volumes_and_diagnosis_no_cc, aes(x=depGroupVar, y=total_fascicle_vol_lost_indepnet_top_quartile_no_cc, fill=depGroupVar)) +
  geom_violin() +  
  geom_boxplot(width=0.1, color="black", fill="white", outlier.size = 0.2) + 
  scale_x_discrete(labels=c("1" = "Depressed", "2" = "Non-Depressed")) + 
  ggtitle(paste0("Mean Fascicle Volume Affected Dep Net by Diagnosis")) +
  ...
  theme(plot.title = element_text(size=16, hjust = 0.55),
        ...
        aspect.ratio=7/5,
        panel.background = element_rect(colour = "white", fill = "white"))
print(violin_mean_fascicle_volume_dep_no_cc) 

violin_mean_fascicle_volume_nondep <- ggplot(df_mean_fascicle_volumes_and_diagnosis, aes(x=depGroupVar, y=total_fascicle_vol_lost_nondep_bottom_3_quartiles,  fill=depGroupVar)) +
  geom_violin() +  
  geom_boxplot(width=0.1, color="black", fill="white", outlier.size = 0.2) + 
  scale_x_discrete(labels=c("1" = "Depressed", "2" = "Non-Depressed")) + 
  ggtitle(paste0("Mean Fascicle Volume Affected Nondep Net by Diagnosis")) +
  ...
  theme(plot.title = element_text(size=16, hjust = 0.55),
        ...
        aspect.ratio=7/5,
        panel.background = element_rect(colour = "white", fill = "white"))
print(violin_mean_fascicle_volume_nondep) 

# geom violin within vs outside depression network
...
net_values <- c(df_mean_fascicle_volumes_and_diagnosis$total_fascicle_vol_lost_indepnet_top_quartile, df_mean_fascicle_volumes_and_diagnosis$total_fascicle_vol_lost_nondep_bottom_3_quartiles)

newdf <- data.frame(dep_net_group, net_values)

#p = 2.2 x 10^-16. But it is kind of irrelevant because corpus callosum, which is periventricular and just so much bigger, is in the depression network so if you look at volume alone, there is really no way to compete. For this, you gotta use proportion. And when you drop the cranial nerves, doesn't work. COuld try dropping CC, but don't know why I coul dmake the case for that. Though honestly, will prob have to try
violin_within_vs_outside_network_fascicle_volume <- ggplot(newdf, aes(x=dep_net_group, y=net_values, fill=dep_net_group)) +
  geom_violin() +  
  geom_boxplot(width=0.1, color="black", fill="white", outlier.size = 0.2) + 
  scale_x_discrete(labels=c("1" = "Dep Net", "2" = "Non-Dep Net")) + 
  ggtitle(paste0("Mean Fascicle Volume Affected by Network")) +
  ylab("Mean Volume of Fascicles") +
  ylim(0,42000) + 
  theme(plot.title = element_text(size=16, hjust = 0.55),
        axis.text = element_text(size = 14, colour = "black"), axis.title.x = element_blank(), 
        ...
        aspect.ratio=7/5,
        panel.background = element_rect(colour = "white", fill = "white"))
print(violin_within_vs_outside_network_fascicle_volume) #

# geom violin within vs outside depression network, no cc
dep_net_group <- c(rep("Dep_net", times = dim(dep_and_healthy_groups_for_ICD_analysis)[1]), rep("Non_dep_net",times =dim(dep_and_healthy_groups_for_ICD_analysis)[1]))
net_values <- c(dep_and_healthy_groups_for_ICD_analysis$total_fascicle_vol_lost_indepnet_top_quartile_no_cc, dep_and_healthy_groups_for_ICD_analysis$total_fascicle_vol_lost_nondep_bottom_3_quartiles_no_cc)

newdf_no_cc <- data.frame(dep_net_group, net_values)

#p = 2.2 x 10^-16. But it is kind of irrelevant because corpus callosum, which is periventricular and just so much bigger, is in the depression network so if you look at volume alone, there is really no way to compete. For this, you gotta use proportion. And when you drop the cranial nerves, doesn't work. COuld try dropping CC, but don't know why I coul dmake the case for that. Though honestly, will prob have to try
violin_within_vs_outside_network_fascicle_volume_no_cc <- ggplot(newdf_no_cc, aes(x=dep_net_group, y=net_values, fill=dep_net_group)) +
  geom_violin() +  
  geom_boxplot(width=0.1, color="black", fill="white", outlier.size = 0.2) + 
  scale_x_discrete(labels=c("1" = "Dep Net", "2" = "Non-Dep Net")) + 
  ggtitle(paste0("Mean Fascicle Volume Affected by Network, no CC")) +
  ylab("Mean Volume of Fascicles") +
  ylim(0,42000) + 
  theme(plot.title = element_text(size=16, hjust = 0.55),
        axis.text = element_text(size = 14, colour = "black"), axis.title.x = element_blank(), 
        ...
        aspect.ratio=7/5,
        panel.background = element_rect(colour = "white", fill = "white"))
print(violin_within_vs_outside_network_fascicle_volume_no_cc) #


### scaling by size of network

dep_net_group <- c(rep("Dep_net", times = dim(dep_and_healthy_groups_for_ICD_analysis)[1]), rep("Non_dep_net",times =dim(dep_and_healthy_groups_for_ICD_analysis)[1]))
net_values <- c(dep_and_healthy_groups_for_ICD_analysis$prop_fascicle_vol_lost_indepnet_top_quartile, dep_and_healthy_groups_for_ICD_analysis$prop_fascicle_vol_lost_bottom_3_quartile)

newdf_no_cc <- data.frame(dep_net_group, net_values)

#p = 2.2 x 10^-16. 
violin_within_vs_outside_network_scaled_by_network_size <- ggplot(newdf_no_cc, aes(x=dep_net_group, y=net_values, fill=dep_net_group)) +
  geom_violin() +  
  geom_boxplot(width=0.1, color="black", fill="white", outlier.size = 0.2) + 
  scale_x_discrete(labels=c("1" = "Dep Net", "2" = "Non-Dep Net")) + 
  ggtitle(paste0("Proportion Fascicle Volume Affected by Network")) +
  ylab("Proportion (mean tot volume lost/Net Vol) ") +
  ylim(0,0.1) + 
  theme(plot.title = element_text(size=16, hjust = 0.55),
        axis.text = element_text(size = 14, colour = "black"), axis.title.x = element_blank(), 
        axis.title.y = element_text(size=16),
        ...
        aspect.ratio=7/5,
        panel.background = element_rect(colour = "white", fill = "white"))
print(violin_within_vs_outside_network_scaled_by_network_size) #

#sums instead of means, scaling by size of network
dep_net_group <- c(rep("Dep_net", times = dim(dep_and_healthy_groups_for_ICD_analysis)[1]), rep("Non_dep_net",times =dim(dep_and_healthy_groups_for_ICD_analysis)[1]))
...
#p = 2.2 x 10^-16. 
violin_within_vs_outside_network_sum_proportion_scaled_by_network_size <- ggplot(newdf_no_cc, aes(x=dep_net_group, y=net_values, fill=dep_net_group)) +
  geom_violin() +  
  geom_boxplot(width=0.1, color="black", fill="white", outlier.size = 0.2) + 
  scale_x_discrete(labels=c("1" = "Dep Net", "2" = "Non-Dep Net")) + 
  ggtitle(paste0("Proportion Fascicle Volume Affected by Network")) +
...
```{r depression_vs_healthy_overall_volume_of_fascicles_affected_dep_net_by_volume}
...
```
```{r depression_vs_healthy_overall_volume_of_fascicles_affected_dep_network_fascicles_determined_by_vol}
...
#dfectine the depression network (all areas that intersect with depression network, no cranial nerves)
fascicle_proportions <- read.csv(paste0(homedir, "/results/fascicle_volumes_all_subjects_roi_n2336.csv"), header = T, sep = ",") #n = 2336
...
```{r comparing_depression_map_overlap_with_dx_diff_no_cranial_nerves_prop_effect_size}
# the purpose of this chunk is to plot the relationship of the degree of overlap of a depression network with the diagnostic difference between groups
...
# lapply to get results of t-test in each fascicle
#ldepGroup 2 is depressed group, Dep group 1 is healthy group. Positive Ts are places where depressed people have more disease than controls
fascicle_dep_vs_healthy_cohen_d <- sapply(fascicle_names_no_cranial_nerves, function(x) 
{
...
names(fascicle_dep_vs_healthy_cohen_d) <- fascicle_names_no_cranial_nerves
...
df_fascicle_dep_mask_overlap_d_value <- data.frame(df_fascicle_and_prop_in_mask$fascicle, df_fascicle_and_prop_in_mask$prop_in_mask, df_d_values)
names(df_fascicle_dep_mask_overlap_d_value) <- c("fascicle", "depression_mask_overlap", "dep_vs_healthy_d")

#make copy to sort
df_fascicle_dep_mask_overlap_d_value_sorted_by_prop_overlap_depression_mask <- df_fascicle_dep_mask_overlap_d_value

df_fascicle_dep_mask_overlap_d_value_sorted_by_prop_overlap_depression_mask$fascicle  <- factor(df_fascicle_dep_mask_overlap_d_value_sorted_by_prop_overlap_depression_mask$fascicle, levels = df_fascicle_dep_mask_overlap_d_value_sorted_by_prop_overlap_depression_mask$fascicle[order(df_fascicle_dep_mask_overlap_d_value_sorted_by_prop_overlap_depression_mask$depression_mask_overlap)])


# bar graph of T-values of fascicles, sorted by depression overlap
plot_fascicle_by_d_sorted_by_dep_overlap <-ggplot(data = df_fascicle_dep_mask_overlap_d_value_sorted_by_prop_overlap_depression_mask, aes(x = fascicle, y=dep_vs_healthy_d), main = "Dep vs Healthy T value, Fascicles ordered by overlap with dep network") + 
  geom_bar(stat="identity") +
  ylim(-0.1,0.5) +
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
print(plot_fascicle_by_d_sorted_by_dep_overlap)


# plot fascicle overlap x t value
#statistic, p = 0.010
dep_overlap_x_dep_vs_healthy_d <- lm(dep_vs_healthy_d ~ depression_mask_overlap, data=df_fascicle_dep_mask_overlap_d_value)
print(summary(dep_overlap_x_dep_vs_healthy_d))

scatter_d_val_by_dep_net_overlap <- ggplot(data=df_fascicle_dep_mask_overlap_d_value, aes(x=depression_mask_overlap, y=dep_vs_healthy_d)) +
  geom_point(size=1) + 
  geom_smooth(method=lm)+
  xlab("Proportion of Fascicle in Depression Network") + 
  ylab("Effect of diagnosis calculated in proportions (D)") + 
  ggtitle(paste0("Fascicle/depression mask Proportion overlap by dx Eff Size, p = ", round(summary(dep_overlap_x_dep_vs_healthy_d)$coefficients[2,4],3))) + 
  theme(plot.title=element_text(hjust=0.5))
...
df_fascicle_dep_mask_volume_t_value_no_cc <- df_fascicle_dep_mask_volume_t_value %>%
  filter(fascicle != "CC")

df_fascicle_dep_mask_overlap_t_value_sorted_by_vol_in_depression_mask <- df_fascicle_dep_mask_volume_t_value_no_cc
...
# bar graph of T-values of fascicles, sorted by depression overlap
plot_fascicle_by_t_sorted_by_dep_overlap <-ggplot(data = df_fascicle_dep_mask_overlap_t_value_sorted_by_vol_in_depression_mask, aes(x = fascicle, y=dep_vs_healthy_t), main = "Dep vs Healthy T value, Fascicles ordered by volume of dep network, no CC") + 
  geom_bar(stat="identity") +
  ylim(0,5) +
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
print(plot_fascicle_by_t_sorted_by_dep_overlap)
...
#statistic volume, 
dep_overlap_x_dep_vs_healthy_t_no_cc <- lm(dep_vs_healthy_t ~ volume_in_dep_mask, data=df_fascicle_dep_mask_volume_t_value_no_cc)
print(summary(dep_overlap_x_dep_vs_healthy_t_no_cc))

scatter_t_val_by_dep_net_overlap_no_cc <- ggplot(data=df_fascicle_dep_mask_volume_t_value_no_cc, aes(x=volume_in_dep_mask, y=dep_vs_healthy_t)) +
  geom_point(size=1) + 
  geom_smooth(method=lm)+
  xlab("Volume of Fascicle in Depression Network") + 
  ylab("Effect of diagnosis (T)") + 
  ggtitle(paste0("Fascicle/depression mask volume by dx T, no CC, p = ", round(summary(dep_overlap_x_dep_vs_healthy_t_no_cc)$coefficients[2,4],3))) + 
  theme(plot.title=element_text(hjust=0.5))
print(scatter_t_val_by_dep_net_overlap_no_cc)

```


Effect size in volume, w /cc (eff size NOT done in proportions)

```{r comparing_depression_map_overlap_with_dx_diff_no_cranial_nerves_vol_effect_size}
# the purpose of this chunk is to plot the relationship of the degree of overlap of a depression network with the diagnostic difference between groups
...
df_fascicle_and_vol_in_mask <- subset(x = fascicle_volumes_dep_network_no_cranial_nerves, select = c("fascicle", "non_zero_voxels_in_dep_map"))
...
df_fascicle_dep_mask_volume_overlap_d_value <- data.frame(df_fascicle_and_vol_in_mask$fascicle, df_fascicle_and_vol_in_mask$non_zero_voxels_in_dep_map, df_d_values)
names(df_fascicle_dep_mask_volume_overlap_d_value) <- c("fascicle", "volume_in_dep_mask", "dep_vs_healthy_d")



#make copy to sort
df_fascicle_dep_mask_overlap_d_value_sorted_by_vol_overlap_depression_mask <- df_fascicle_dep_mask_volume_overlap_d_value

df_fascicle_dep_mask_overlap_d_value_sorted_by_vol_overlap_depression_mask$fascicle  <- factor(df_fascicle_dep_mask_overlap_d_value_sorted_by_vol_overlap_depression_mask$fascicle, levels = df_fascicle_dep_mask_overlap_d_value_sorted_by_vol_overlap_depression_mask$fascicle[order(df_fascicle_dep_mask_overlap_d_value_sorted_by_vol_overlap_depression_mask$volume_in_dep_mask)])


# bar graph of eff size of fascicles, sorted by depression overlap
plot_fascicle_by_d_sorted_by_dep_overlap <-ggplot(data = df_fascicle_dep_mask_overlap_d_value_sorted_by_vol_overlap_depression_mask, aes(x = fascicle, y=dep_vs_healthy_d), main = "Dep vs Healthy T value, Fascicles ordered by overlap with dep network") + 
  geom_bar(stat="identity") +
  #ylim(-0.1,0.5) +
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
print(plot_fascicle_by_d_sorted_by_dep_overlap)
...
scatter_d_val_by_dep_net_overlap <- ggplot(data=df_fascicle_dep_mask_volume_overlap_d_value, aes(x=volume_in_dep_mask, y=dep_vs_healthy_d)) +
  ...
  xlab("Volume of Fascicle in Depression Network") + 
  ylab("Effect Size (D)") + 
  ggtitle(paste0("Effect of Diagnosis by Overlap with Depression Network, p = ", round(summary(dep_overlap_x_dep_vs_healthy_vol_d )$coefficients[2,4],3))) + 
...
#no corpus callosum
df_no_cc <- df_fascicle_dep_mask_volume_overlap_d_value %>% filter(fascicle != "CC")

dep_overlap_x_dep_vs_healthy_vol_d_no_cc <- lm(dep_vs_healthy_d ~ volume_in_dep_mask, data=df_no_cc )
print(summary(dep_overlap_x_dep_vs_healthy_d))

scatter_d_val_by_dep_net_overlap_no_cc <- ggplot(data=dep_overlap_x_dep_vs_healthy_vol_d_no_cc, aes(x=volume_in_dep_mask, y=dep_vs_healthy_d)) +
  geom_point(size=1) + 
  geom_smooth(method=lm)+
  xlab("Volume of Fascicle in Depression Network") + 
  ylab("Effect Size (D)") + 
 ggtitle(paste0("Effect of Diagnosis by Overlap with Depression Network, p = ", round(summary(dep_overlap_x_dep_vs_healthy_vol_d_no_cc)$coefficients[2,4],3))) + 
#  ggtitle(paste0("Effect of Diagnosis by Overlap with Depression Network, excluding CC")) + 
  theme(plot.title=element_text(hjust=0.5),
        axis.text = element_text(size=12, color = "black"),
        axis.title = element_text(size=14, color = "black"),
        axis.line = element_line(color="black", size=1.3),
        panel.background = element_blank())
print(scatter_d_val_by_dep_net_overlap_no_cc)
...
```{r bootstrapping_proportion_and_volume_x_dep_t_analyses_and_eff_sizes}
...
plot(results_prop)
boot_results_prop.ci <- boot.ci(results_prop, conf=0.95, type="perc", index=1)
print(boot_results_prop.ci)
pval_prop<-boot.pval(boot_res=results_prop, theta_null = 0, type = "perc", pval_precision = NULL)
print(pval_prop) #p=0.0087

##### effect size
# 95% confidence intervals for the correlation

set.seed(1)
data_frame_dep_v_nondep_d_x_prop_dep_mask_overlap <- subset(df_fascicle_dep_mask_overlap_d_value, select = c("depression_mask_overlap","dep_vs_healthy_d"))
results_prop <- boot(data=data_frame_dep_v_nondep_d_x_prop_dep_mask_overlap, statistic=tval,
   R=10000, formula=dep_vs_healthy_d~depression_mask_overlap)
print(results_prop) #actual 2.62, CI 0.589, 4.669)
plot(results_prop)
boot_results_prop.ci <- boot.ci(results_prop, conf=0.95, type="perc", index=1)
print(boot_results_prop.ci)
pval_prop<-boot.pval(boot_res=results_prop, theta_null = 0, type = "perc", pval_precision = NULL)
print(pval_prop) #p=0.0083
...
### with no corpus callosumm p = 1* 10^-16, CI(1.727, 5.363)
# 95% confidence intervals for the correlation

data_frame_dep_v_nondep_d_x_vol_dep_mask_no_cc <- df_fascicle_dep_mask_volume_overlap_d_value %>%
  filter(fascicle != "CC") %>%
  dplyr::select("dep_vs_healthy_d", "volume_in_dep_mask")

set.seed(1)
results_vol <- boot(data=data_frame_dep_v_nondep_d_x_vol_dep_mask_no_cc, statistic=tval,
   R=10000, formula=dep_vs_healthy_d~volume_in_dep_mask)
print(results_vol)
plot(results_vol)
boot_results_vol.ci <- boot.ci(results_vol, conf=0.95, type="perc", index=1)
...
```{r compare_overall_promis_scores_by_diagnosis}

#separate out only people in depression group, and take first instance
dep_and_healthy_groups_for_ICD_analysis <-  df_people_with_promis_data_scores_added %>% 
  filter(depGroupVar != 0)  %>% 
  group_by(EMPI) %>% 
  arrange(EXAM_DATE) %>% 
  slice(1) %>% 
...
dep_vs_healthy_t <- lapply(promis_score_names, function(x) 
{
  t_test_command <- paste0("t.test(dep_and_healthy_groups_for_ICD_analysis$", x, "[dep_and_healthy_groups_for_ICD_analysis$depGroupVar == 2], dep_and_healthy_groups_for_ICD_analysis$", x, "[dep_and_healthy_groups_for_ICD_analysis$depGroupVar == 1], var.equal=F)")
  eval(parse(text=t_test_command))
})
names(dep_vs_healthy_t) <- promis_score_names
print(dep_vs_healthy_t)

#pull t-statistic
dep_vs_healthy_t_values <- sapply(dep_vs_healthy_t, function(x) x$statistic)

#convert to data frame
df_t_values <- as.data.frame(dep_vs_healthy_t_values) 
row.names(df_t_values) <- promis_score_names
print(df_t_values)

#pull p-values
dep_vs_healthy_p_values <- sapply(dep_vs_healthy_t, function(x) x$p.value)

#convert to data frame
df_dep_vs_healthy_p_values <- as.data.frame(dep_vs_healthy_p_values)
row.names(df_dep_vs_healthy_p_values) <- promis_score_names
print(df_dep_vs_healthy_p_values)
#FDR correct p-values
dep_vs_healthy_pfdr <- p.adjust(dep_vs_healthy_p_values,method="fdr")
  
plots <- lapply(promis_score_names, function(x) 
{
 
  Diagnosis <- c("MS w/Depression", "MS No Depression")
  dep_group <- eval(parse(text=paste0("dep_and_healthy_groups_for_ICD_analysis$", x, "[dep_and_healthy_groups_for_ICD_analysis$depGroupVar == 2]")))
  nondep_group <- eval(parse(text=paste0("dep_and_healthy_groups_for_ICD_analysis$", x, "[dep_and_healthy_groups_for_ICD_analysis$depGroupVar == 1]")))
  value <- c(mean(dep_group, na.rm=TRUE),
           mean(nondep_group, na.rm=TRUE))
  sem=c((sd(dep_group, na.rm = TRUE)/sqrt(sum(dep_group, na.rm = TRUE))), (sd(nondep_group, na.rm = TRUE)/sqrt(sum(nondep_group, na.rm = TRUE))))
  ...
  barplot <- ggplot(data, aes(x=reorder(Diagnosis, -value),fill=Diagnosis, y=value)) + 
    geom_bar(stat="identity", colour="black", width=0.8, size=1.5) + 
      geom_errorbar(aes(ymin=value-sem, ymax=value+sem), width=.1, position=position_dodge(0.9), size=1.5) +
    scale_fill_manual(values = c("#cdcdcd", "#FFFFFF")) + #comment out if you want colored graph
    ggtitle(paste0(x, " by Diagnosis")) + #, p=", round(dep_vs_healthy_t_test$p.value,3))) +
    ylab(paste0("Promis ", x)) +
...
#### PROMIS Proportion analyses

```{r depression_vs_healthy_overall_proportion_of_fascicles_affected_promis}

#goal of this segment is to look at overall lesion burden within/outside depression network, and correlate with promis scores between depression and controls, outside of fascicles
#I'll read in the volume of each fascicle, and multiply it by the proportion of volume loss in each subject, thereby returing the volume of the fascicle affected
...
fascicle_proportion_lost_categories <- c("total_fascicle_prop_lost", "total_fascicle_prop_lost_indepnet_top_quartile", "total_fascicle_prop_lost_nondep_bottom_3_quartiles")

promis_lm <- lapply(promis_score_names, function(promis_score) {
 
  fascicle_lm <- lapply(fascicle_proportion_lost_categories, function(fascicle) 
  {
    lm(substitute(fascicle ~ promis_score, list(fascicle = as.name(fascicle), promis_score=as.name(promis_score))), 
       data = dep_and_healthy_groups_for_ICD_analysis)
  })
  names(fascicle_lm) <- fascicle_proportion_lost_categories
...
```{r depression_vs_healthy_overall_proportion_of_fascicles_affected_promis_dep_and_nondep}
...
```{r depression_vs_healthy_overall_proportion_of_fascicles_affected_promis_nondep}
...
```{r depression_vs_healthy_overall_proportion_of_fascicles_affected_promis_dep}
...
```{r dimensional_promis_effects_unique_irrespective_of_dx}

#total n = 116, nothing significant
...
#[1] "Quality_of_Life"                  "Physical_Health"                  "Mental_Health_and_Mood"           "Social_Activities_Satisfaction"  
# [5] "Carrying_Out_Social_Activities"   "Carrying_Out_Physical_Activities" "Emotional_Problems"               "Fatique_Average"                 
# [9] "PostOp.PROMIS.Physical.Score"     "PostOp.PROMIS.Mental.Score"      

#lm
promis_lm <- lapply(promis_score_names, function(promis_score) {
 
  fascicle_lm <- lapply(fascicle_names_no_cranial_nerves, function(fascicle) 
  {
    lm(substitute(fascicle ~ promis_score, list(fascicle = as.name(fascicle), promis_score=as.name(promis_score))), 
       data = dep_and_healthy_groups_for_ICD_analysis)
  })
  names(fascicle_lm) <- fascicle_names_no_cranial_nerves
...
```{r dimensional_promis_effects_unique_depressed_and_nondepressed}

#total n = 82, nothing significant
...
```{r dimensional_promis_effects_unique_nondepressed}

#total n = 36, nothing significant
...
```{r dimensional_promis_effects_unique_depressed}

#total n = 46, nothing significant
...
#### PROMIS VOLUME ANALYSES




```{r depression_vs_healthy_overall_volume_of_fascicles_affected_promis}
...
#isolate out only the depressed group and healthy group, make a column that sums up the total volume loss, only pay attention to places without cranial nerves
dep_and_healthy_groups_for_ICD_analysis <- df_demo_and_fascicle_volumes_full_w_promis  %>% 
 # filter(depGroupVar != 0)  %>% 
  mutate(total_fascicle_prop_lost = rowMeans(across(fascicle_names_no_cranial_nerves))) %>%
  mutate(total_fascicle_prop_lost_indepnet_top_quartile = 
           rowMeans(across(dep_network_names_top_quartile_no_cranial_nerves))) %>%
...
```{r depression_vs_healthy_overall_volume_of_fascicles_affected_promis_dep_and_nondep}
...
```{r depression_vs_healthy_overall_volume_of_fascicles_affected_promis_nondep}
...
```{r depression_vs_healthy_overall_volume_of_fascicles_affected_promis_dep}
...
```{r dimensional_promis_effects_unique_irrespective_of_dx_vol}
...
```{r dimensional_promis_effects_unique_depressed_and_nondepressed_vol}
...
```{r dimensional_promis_effects_unique_nondepressed_vol}
...
```{r dimensional_promis_effects_unique_depressed_vol}
...
```{r age_effects_fascicles_unique_volume}
...
visreg(fascicle_age_lm$AF_R,ylab = "Volume of Affected Streamlines", xlab = "Age in Years",
       line=list(col="red"),
       points=list(col="black"))

### Mean Volume loss x age
age_x_vol_affected <- lm(total_fascicle_vol_lost~ PAT_AGE_AT_EXAM, data=dep_and_healthy_groups_for_ICD_analysis )
print(summary(age_x_vol_affected))
visreg(age_x_vol_affected, gg=TRUE) + 
  xlab("Age") + 
  ylab("Mean Volume of Fascicle Affected") + 
  ggtitle("Mean Volume of Fascicles Affected by Age, p = 2.1*10^-5") + 
  theme(plot.title = element_text(hjust = 0.5))

scatter_age_x_vol_affected <- ggplot(data=age_x_vol_affected, aes(x=PAT_AGE_AT_EXAM, y=total_fascicle_vol_lost)) +
  geom_point(size=1) + 
  geom_smooth(method=lm)+
  xlab("Age") + 
  ylab("Mean Volume of Fascicles Affected") + 
  ...
  theme(plot.title = element_text(hjust = 0.5, size=20),
        ...
        axis.line = element_line(size = 1.5, colour = "black", linetype=1),
        panel.background = element_rect(colour = "white", fill = "white"))
print(scatter_age_x_vol_affected)
