...
#### Inclusion criteria for Nondepressed Group
...
scatter_effsize_val_by_dep_net_overlap <- ggplot(data=df_fascicle_dep_mask_volume_overlap_effsize_value, aes(x=volume_in_dep_mask, y=dep_vs_healthy_effsize)) +
  geom_point(size=1) + 
  ...
  ggtitle(paste0("Effect of Diagnosis by Overlap with Depression Network, p = ", pval_vol)) + 
                 #round(summary(dep_overlap_x_dep_vs_healthy_vol_effsize )$coefficients[2,4],3))) + 
