...
get_fascicle_bundle_mapping <- function(){
  ...
  fascicle_bundle_list <- list(numerical_vector, name_vector, inDepNetwork_vector)
  names(fascicle_bundle_list) <- c("numerical_vector", "name_vector", "inDepNetwork_vector")
