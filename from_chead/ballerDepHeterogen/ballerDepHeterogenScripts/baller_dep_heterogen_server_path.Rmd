---
title: "Baller_dep_heterogeneity"
author: "Erica Baller"
date: "12/12/2017"
...
Welcome to Baller Depression Heterogeneity!  This document contains the code and output generated from 
12/12/2017: Subsetting and running mass univariate analysis on CNB cognitive scores

```{r baller_depression_heterogeneity}
...
```
## Including CNB measures that are FDR corrected

```{r CNB_names_and_fdr_values}
print(CNB_names_and_fdr_values_lm)
print(CNB_names_and_fdr_values_gam)
```

## Including Tables

Table 1: Demographics no levels shown
```{r R_demo, echo=TRUE}

print(demographics_table)
```

Table 1: Demographics, levels shown
```{r R_demo_levels, echo=TRUE}
print(demographics_table, showAllLevels = TRUE)
```
