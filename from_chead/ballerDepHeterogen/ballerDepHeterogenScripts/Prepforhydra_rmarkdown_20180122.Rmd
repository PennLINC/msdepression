---
title: "Prep_for_hyrda_with_matching"
output:
...
write.csv(subset_bblidAndCovariates, file="/Users/eballer/BBL/from_chead/ballerDepHeterogen/results/hydra_all_gender/Covariates.csv", row.names = FALSE, quote = FALSE)
write.csv(subset_bblidAndCog_features_males, file="/Users/eballer/BBL/from_chead/ballerDepHeterogen/results/hydra_males/Features.csv", row.names = FALSE, quote = FALSE)
write.csv(subset_bblidAndCovariates_males, file="/Users/eballer/BBL/from_chead/ballerDepHeterogen/results/hydra_males/Covariates.csv", row.names = FALSE, quote = FALSE)
write.csv(subset_bblidAndCog_features_females, file="/Users/eballer/BBL/from_chead/ballerDepHeterogen/results/hydra_females/Features.csv", row.names = FALSE, quote = FALSE)
write.csv(subset_bblidAndCovariates_females, file="/Users/eballer/BBL/from_chead/ballerDepHeterogen/results/hydra_females/Covariates.csv", row.names = FALSE, quote = FALSE)
